...
class KendiGonderiDetay extends StatefulWidget {
  ...
  @override
  KendiGonderiDetayState createState() => KendiGonderiDetayState();
}

class KendiGonderiDetayState extends State<KendiGonderiDetay> {
  ...
  hmmLetsSee() {
    if (widget.gonderi.postIlan) {
      return TextButton(onPressed: () {}, child: const Text("BAŞVUR"));
    } else {
